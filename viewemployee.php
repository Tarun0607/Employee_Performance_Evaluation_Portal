...
<?php
 ...
 <div class="form-group">
    <br>
    <label>&emsp;&emsp;<strong>Assigned Tasks</strong></label>
  </div>
  <?php
    ...
    if(isset($_POST["searchname"])){
    $empname=$_POST['empname'];    
    $query="select t.TaskID,t.Task_name from employee e,tasks t where Username='$empname' AND t.EmpID=(select EmpID from employee where Username='$empname')";
